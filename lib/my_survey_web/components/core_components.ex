defmodule MySurveyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MySurveyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MySurveyWeb.Gettext, "errors", msg, opts)
    end
  end
