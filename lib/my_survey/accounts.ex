defmodule MySurvey.Accounts do
  @moduledoc """
  ...
  alias MySurvey.Accounts.{User, UserToken, UserNotifier}
  ...
  See `MySurvey.Accounts.User.email_changeset/3` for a list of supported options.
